    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2 flex-shrink-0">
            <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border"
                  style="background: {{ $faq->is_active ? 'rgba(52,211,153,0.1)' : 'rgba(148,163,184,0.1)' }};
                         border-color: {{ $faq->is_active ? 'rgba(52,211,153,0.3)' : 'rgba(148,163,184,0.3)' }};
                         color: {{ $faq->is_active ? '#34d399' : 'var(--text-4)' }};">
