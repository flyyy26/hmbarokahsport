...
<div class="w-full space-y-6">
        ...
        <div class="min-w-0">
            <h1 class="text-2xl font-bold flex items-center gap-2.5" style="color: var(--text-1)">
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-xl
                    ...
                    <iconify-icon icon="mdi:newspaper-variant-outline" class="text-slate-900 text-2xl"></iconify-icon>
                </span>
                Artikel
            </h1>
            <p class="text-sm mt-1.5 ml-12" style="color: var(--text-5)">
                Kelola artikel blog dan konten toko.
            </p>
        </div>
    ...
    @php
        ...
        $inactiveArticles = $articles->where('is_active', false)->count();
    @endphp
    ...
    <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div class="rounded-xl border p-4 text-center transition-colors"
            ...
            <p class="text-2xl font-bold" style="color: var(--text-1);">{{ $totalArticles }}</p>
        ...
        <div class="rounded-xl border p-4 text-center transition-colors"
             ...
             onmouseout="this.style.borderColor='var(--border-2)'">
            <p class="text-2xl font-bold text-emerald-400">{{ $activeArticles }}</p>
        ...
        <div class="rounded-xl border p-4 text-center transition-colors"
             ...
             onmouseout="this.style.borderColor='var(--border-2)'">
            <p class="text-2xl font-bold" style="color: var(--text-4);">{{ $inactiveArticles }}</p>
        ...
        <div class="flex flex-wrap gap-2 flex-1">
            ...
            @foreach($filters as $filter)
                @php
                    ...
                    $url = $filter['value']
                        ? route('admin.articles.index', ['status' => $filter['value']])
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-start gap-3">
                                    <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0
                                        ...
                                        <iconify-icon icon="mdi:newspaper-variant-outline" class="text-slate-900 text-lg"></iconify-icon>
                                    </div>
                                    <div class="min-w-0">
                            ...
                            <td colspan="6" class="px-6 py-20">
                                <div class="flex flex-col items-center justify-center text-center max-w-sm mx-auto">
                                    <div class="w-16 h-16 rounded-full flex items-center justify-center mb-4 border"
                                         style="background: var(--bg-input); border-color: var(--border-2)">
                                        <iconify-icon icon="mdi:newspaper-variant-outline" class="text-2xl" style="color: var(--text-6)"></iconify-icon>
                                    </div>
                                    <p class="text-sm font-semibold mb-1" style="color: var(--text-3)">
                                        Belum ada artikel
                                    </p>
                                    <p class="text-xs mb-4" style="color: var(--text-5)">
                                        Mulai tulis artikel pertama untuk blog toko Anda.
                                    </p>
                                    <a href="{{ route('admin.articles.create') }}"
