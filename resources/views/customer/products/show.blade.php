                                ...
                                <div class="accordion-body-inner">
                                    @if($testimonials->isNotEmpty())
                                        @foreach($testimonials as $testimonial)
                                            <div class="buyer-review-item">
                                                <div class="review-header">
                                                    <div class="reviewer-avatar">
                                                        {{ substr($testimonial->customer_name, 0, 1) }}
                                                    </div>
                                                    <div class="reviewer-info">
                                                        <div class="reviewer-name">{{ $testimonial->customer_name }}</div>
                                                ...
                                                @if($testimonial->product_variant_id)
                                                    <div class="review-title">{{ $testimonial->variant_label }}</div>
                                                @endif
                                                ...
                                                @if($testimonial->first_image_url)
                                                    <div class="review-image">
                                                        <img src="{{ $testimonial->first_image_url }}">
                                                    </div>
                                                @endif
                                            </div>
                                        @endforeach
