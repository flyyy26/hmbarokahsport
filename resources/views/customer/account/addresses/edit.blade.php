...
<style>
    ...
    .af-edit-banner iconify-icon {
        font-size: 1.2vw;
        color: #ecbc42;
        flex-shrink: 0;
    }

    .af-edit-banner strong {
        font-weight: 700;
    }
    ...
    @media (max-width: 1024px) {
        ...
        .af-edit-banner iconify-icon { font-size: 3vw; }
    ...
    @media (max-width: 480px) {
        ...
        .af-edit-banner iconify-icon { font-size: 4.5vw; }
...
<form action="{{ route('customer.addresses.update', $address) }}" method="POST" class="af-wrapper">
    @csrf
    @method('PUT')

    {{-- Info Banner --}}
    <div class="af-edit-banner">
        <iconify-icon icon="mdi:pencil-outline"></iconify-icon>
        <div>
            Anda sedang mengedit alamat <strong>{{ $address->label ?: 'Alamat #' . $address->id }}</strong>.
    ...
    <div class="af-group">
        ...
        <textarea name="address" id="address" rows="3" required 
                  ...
                  class="af-textarea @error('address') has-error @enderror">{{ old('address', $address->address) }}</textarea>
        @error('address')
            <p class="af-error">
                <iconify-icon icon="mdi:alert-circle-outline"></iconify-icon>
                {{ $message }}
