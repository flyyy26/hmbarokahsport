...
<body>
    ...
    <script>
        ...
        function openLoginPopup(action, callback) {
            ...
            // Reset form login
            document.getElementById('login-popup-phone').value = '';
            ...
            document.getElementById('register-popup-phone').value = '';
            ...
            setTimeout(function() {
                document.getElementById('login-popup-phone').focus();
            }, 300);
        }
        ...
        function submitLoginPopup(event) {
            ...
            const phone = document.getElementById('login-popup-phone').value;
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    errorMessage.textContent = data.message || 'Nomor HP atau password salah';
        ...
        function submitRegisterPopup(event) {
            ...
            const phone = document.getElementById('register-popup-phone').value;
            ...
            if (!phone || phone.length < 8) {
                errorMessage.textContent = 'Masukkan nomor HP yang valid';
                errorDiv.style.display = 'flex';
                return;
            }
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    setTimeout(function() {
                        if (typeof callback === 'function') {
                            callback();
                        } else if (action === 'add_to_cart' && window._pendingProductId) {
                            fetch('/api/products/' + window._pendingProductId + '/variants', {
                                headers: { 'Accept': 'application/json' }
                            })
                            .then(function(response) { return response.json(); })
                ...
                if (data.success && data.vouchers && data.vouchers.length > 0) {
                    ...
                    container.innerHTML = `
                        <div class="popup-empty">
                            ...
                            <p>Cek kembali nanti untuk promo menarik!</p>
                        </div>
                    `;
                }
            })
