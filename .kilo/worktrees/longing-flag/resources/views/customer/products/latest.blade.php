...
@section('title', 'Produk Terbaru - Barokah Sport')
...
<div class="catalog-container">
    <div class="katalog_top_container">
        <div class="catalog-header">
            ...
            <p>Produk-produk terbaru dari Barokah Sport</p>
        </div>

        {{-- ============================================ --}}
        {{-- FILTER ROW - CUSTOM SELECT --}}
        {{-- ============================================ --}}
        <form id="filter-form" method="GET" action="{{ route('customer.products.latest') }}" class="filter-row">
            @if(request('search'))
            ...
            @if(request()->anyFilled(['category', 'gender', 'size', 'color', 'sort']))
                <a href="{{ route('customer.products.latest') }}" class="filter-reset">
                    ✕ Reset
                </a>
            @endif
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🔥 Produk terbaru siap');
});
</script>
