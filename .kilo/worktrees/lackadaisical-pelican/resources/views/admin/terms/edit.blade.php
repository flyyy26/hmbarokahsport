...
<div class="mx-auto max-w-4xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Edit Syarat & Ketentuan</h1>
        <p class="mt-1 text-sm text-gray-500">Perbarui syarat dan ketentuan yang berlaku.</p>
    </div>

    <form action="{{ route('admin.terms.update', $term) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="version" value="{{ old('version', $term->version) }}"
                       class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            ...
            <div class="mb-5">
                ...
                <input type="date" name="effective_date" 
                       value="{{ old('effective_date', $term->effective_date?->format('Y-m-d')) }}"
                       class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
